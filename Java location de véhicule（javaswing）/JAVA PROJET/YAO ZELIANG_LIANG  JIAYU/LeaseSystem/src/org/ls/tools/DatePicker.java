...
//DatePicker startTimePicker = DatePicker.getInstance();
//startTimePicker.register(startTimeTextField);
...
public class DatePicker extends JPanel {
	...
	private java.awt.Font font = new java.awt.Font("Times",
	...
	private static final String[] showTEXT = { "Sun", "Mon", "Tue", "Wen", "Thr",
			"Fri", "Sat" };
	...
	private DatePicker(java.util.Date date, String format, int startDAY) {
	...
	public static DatePicker getInstance(java.util.Date date, String format) {
		return new DatePicker(date, format, defaultStartDAY);
	}

	public static DatePicker getInstance(java.util.Date date) {
		return getInstance(date, DEFAULTFORMAT);
	}

	public static DatePicker getInstance(String format) {
	...
	private void initCalendarPanel() {
		...
		calendarPanel.setBorder(javax.swing.BorderFactory
				.createLineBorder(new java.awt.Color(0xAA, 0xAA, 0xAA)));
		calendarPanel.add(titlePanel = new TitlePanel(),
				java.awt.BorderLayout.NORTH);
		calendarPanel.add(bodyPanel = new BodyPanel(),
				java.awt.BorderLayout.CENTER);
		calendarPanel.add(footerPanel = new FooterPanel(),
	...
	private void showPanel(Component owner) {
		...
		if (y > size.height - 167)
			y -= 165;
		pop = PopupFactory.getSharedInstance().getPopup(owner, calendarPanel,
				x, y);
		pop.show();
		isShow = true;
	}
	...
	private class LabelManager {
		...
		public LabelManager() {
			list = new ArrayList<DatePicker.DayLabel>();
		}
