 ...
 * 查看汽车订单详情
 */
public class CheckAutoOrderUI extends JFrame {
	 ...
	 */
	public CheckAutoOrderUI(Exemplaire order) {
		this.order = order;
		this.setTitle("les informations de la commande");
		/* 设置显示的位置和窗体大小 */
	...
	public void layoutComponents() {
		...
		jTextXingHao.setText(order.getXingHao());
