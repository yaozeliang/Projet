...
//		 create an empty model
    ...
    static public String getValueOfObjectProperty(Model model, String namespace, String objectName, String propertyName) {
		String propertyValue = null;
    	Resource rs = model.getResource(namespace + objectName);
		Property p = model.getProperty(namespace + propertyName);
    	if ((rs != null) && (p != null)) {
    		propertyValue = model.getProperty(rs, p).getObject().toString();
    	}
    	return propertyValue;
    }
    
    static public String getValueOfDataTypeProperty(Model model, String namespace, String instanceName, String propertyName) {
		String propertyValue = null;
		Resource rs = model.getResource(namespace + instanceName);
		Property p = model.getProperty(namespace + propertyName);
		if ((rs != null) && (p != null)) {
			propertyValue = model.getProperty(rs, p).getString();
		}
    	return propertyValue;
    }
    /**
